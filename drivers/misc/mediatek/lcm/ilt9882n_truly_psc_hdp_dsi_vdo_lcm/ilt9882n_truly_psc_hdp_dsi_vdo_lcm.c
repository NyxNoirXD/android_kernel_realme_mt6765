...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0xE0,27,{0x00,0x24,0x76,0xAB,0xEB,0x55,0x20,0x49,0x79,0xA0,0xA9,0xDE,0x11,0x3D,0x68,0xEA,0x94,0xC6,0xE6,0x0D,0xFF,0x2C,0x55,0x85,0xB5,0x03,0xEC}},								
	{0xE1,27,{0x00,0x24,0x76,0xAB,0xEB,0x55,0x20,0x49,0x79,0xA0,0xA9,0xDE,0x11,0x3D,0x68,0xEA,0x94,0xC6,0xE6,0x0D,0xFF,0x2C,0x55,0x85,0xB5,0x03,0xEC}},								
...
static void lcm_init(void)
{
	...
	if (lcm_dsi_mode == CMD_MODE) {
		...
		pr_debug("ili9882n_truly_lcm_mode = vdo mode :%d\n", lcm_dsi_mode);
	}
...
#define BACKLIGTT_MAX  2047
#define BACKLIGHT_20MA  1780
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	unsigned int bl = 0;
	bl = ((level*BACKLIGHT_20MA)/BACKLIGTT_MAX);
	bl_level[0].para_list[0] = 0x000F&(bl >> 7);
	bl_level[0].para_list[1] = 0x00FF&(bl << 1);
	pr_debug("[ HW check backlight ili9882n+truly]level=%d,bl=%d,para_list[0]=%x,para_list[1]=%x\n",
		level, bl, bl_level[0].para_list[0], bl_level[0].para_list[1]);
...
struct LCM_DRIVER ilt9882n_truly_psc_hdp_dsi_vdo_lcm_drv = {
	.name = "ilt9882n_truly_psc_hdp_dsi_vdo_lcm",
